...
public class FilterProductAdapter extends RecyclerView.Adapter<FilterProductAdapter.FilterProductViewHolder> {
    ...
    public void onBindViewHolder(@NonNull FilterProductViewHolder holder, int position) {
        ...
        holder.tvPriceProduct.setText(currencyFormat.format((int)(product.getGia_ban() - product.getGia_ban() * product.getKhuyen_mai())) + " VND");
