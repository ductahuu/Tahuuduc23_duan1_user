...
import com.example.tahuuduc23_duan1_user.adapter.AvatarAdapter;
    ...
    ActivityResultLauncher<String> mGetContent = registerForActivityResult(new ActivityResultContracts.GetContent(),
            uri -> {
                if (uri != null){
                    ...
                    progressDialog.setMessage("Cập nhập ảnh ...");
                    progressDialog.show();
                    StorageReference fileRef = FirebaseStorage.getInstance().getReference("imageAvater/")
