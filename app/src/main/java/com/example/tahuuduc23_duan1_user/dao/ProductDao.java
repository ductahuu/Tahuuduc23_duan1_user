...
import com.example.tahuuduc23_duan1_user.interface_.IAfterDeleteObject;
    ...
    public void getSanPhamPhoBien(int soLuong,IAfterGetAllObject iAfterGetAllObject){
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Collections.sort(resultList2,((o1, o2) -> Integer.compare(o2.getSo_luong_da_ban(),o1.getSo_luong_da_ban())));
